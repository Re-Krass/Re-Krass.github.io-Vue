...
.home
	v-container(grid-list-md fluid)
		...
		v-layout
			v-flex(xs12)
				Section(icon="info" title="1. Datenschutz auf einen Blick")
					.text-container
						div 
		...
		v-layout
			v-flex(xs12)
				Section(icon="mdi-server-security" title="2. Hosting")
					.text-container
						div 
							h2 
							h3 Externes Hosting
		...
		v-layout
			v-flex(xs12)
				Section(icon="announcement" title="3. Allgemeine Hinweise und Pflichtinformationen")
					.text-container
						div 
							h3 Datenschutz
							p
		...
		v-layout
			v-flex(xs12)
				Section(icon="mdi-cookie" title="4. Datenerfassung auf dieser Website")
					.text-container
						div 
							h3 Cookies
							p
		...
		v-layout
			v-flex(xs12)
				Section(icon="email" title="5. Newsletter")
					.text-container
						div 
							h3 Newsletterdaten
							p
		...
		v-layout
			v-flex(xs12)
				Section(icon="cloud" title="6. Plugins und Tools")
					.text-container
						div 
							h3 Google Web Fonts
							p
		...
		v-layout
			v-flex(xs12)
				Section(icon="search" title="Quellen")
					.text-container
						div 
							| Quelle: 
